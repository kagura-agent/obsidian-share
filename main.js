var k=Object.defineProperty;var L=Object.getOwnPropertyDescriptor;var P=Object.getOwnPropertyNames;var R=Object.prototype.hasOwnProperty;var B=(i,r)=>{for(var t in r)k(i,t,{get:r[t],enumerable:!0})},O=(i,r,t,e)=>{if(r&&typeof r=="object"||typeof r=="function")for(let s of P(r))!R.call(i,s)&&s!==t&&k(i,s,{get:()=>r[s],enumerable:!(e=L(r,s))||e.enumerable});return i};var A=i=>O(k({},"__esModule",{value:!0}),i);var M={};B(M,{default:()=>y});module.exports=A(M);var a=require("obsidian"),h=require("fs"),c=require("path"),F=require("http"),E={outputDirectory:"",baseUrl:"http://localhost:8080/",slugLength:8,autoUpdateOnSave:!0,serverEnabled:!0,serverPort:8080},C="abcdefghijklmnopqrstuvwxyz0123456789";function N(i){let r="";for(let t=0;t<i;t++)r+=C.charAt(Math.floor(Math.random()*C.length));return r}function H(i,r){return`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
